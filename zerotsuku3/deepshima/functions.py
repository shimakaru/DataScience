import numpy as np
import deepshima
from deepshima import cuda, utils
from deepshima.core import Function, Variable, as_variable, as_array
...
class GetItemGrad(Function):
    ...
    def forward(self, gy):
        xp = deepshima.cuda.get_array_module(gy)
...
class BroadcastTo(Function):
    ...
    def forward(self, x):
        self.x_shape = x.shape
        xp = deepshima.cuda.get_array_module(x)
...
# =============================================================================
from deepshima.functions_conv import conv2d
from deepshima.functions_conv import deconv2d
from deepshima.functions_conv import conv2d_simple
from deepshima.functions_conv import im2col
from deepshima.functions_conv import col2im
from deepshima.functions_conv import pooling_simple
from deepshima.functions_conv import pooling
from deepshima.functions_conv import average_pooling
from deepshima.core import add
from deepshima.core import sub
from deepshima.core import rsub
from deepshima.core import mul
from deepshima.core import div
from deepshima.core import neg
from deepshima.core import pow